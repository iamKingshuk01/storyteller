...
const stories = [
    { title: "Sunday Suspense", src: "AUDIO/sunday-suspense.mp3" },
    { title: "Mirchi Bangla",   src: "AUDIO/mirchi-bangla.mp3" },
    { title: "Love Story",      src: "AUDIO/love-story.mp3" },
    { title: "Horror Story",    src: "AUDIO/horror-story.mp3" }
];
